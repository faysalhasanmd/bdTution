...
const MyAppliedTuition = () => {
  ...
  const fetchApplications = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `https://miraculous-vibrancy-production.up.railway.app//applications/tutor/${user.email}`,
      );
  ...
  const handleUpdate = async (id) => {
    if (!salary) return;
    const res = await fetch(
      `https://miraculous-vibrancy-production.up.railway.app//applications/update/${id}`,
      {
        method: "PATCH",
