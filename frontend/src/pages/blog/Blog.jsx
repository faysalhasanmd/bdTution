...
const BLOG_POSTS = [
  ...
  {
    id: 4,
    title: "How to Build a Standout Tutor Profile on eTuitionBD",
    excerpt:
  ...
  },
  {
    ...
    excerpt:
      "Math, Physics, and English consistently top the list. We analyzed thousands of tuition requests on eTuitionBD to identify where students struggle most — and why.",
    category: "Education",
    author: "Arif Hossain",
    authorAvatar: "AH",
    date: "March 22, 2025",
  ...
  },
  {
    ...
    excerpt:
      "Despite progress in enrollment, access to quality private tutoring remains unequal. eTuitionBD is working to change that — here's the story and what still needs to be done.",
    category: "Education",
    author: "Tania Begum",
    authorAvatar: "TB",
  ...
  {
    id: 15,
    title: "How eTuitionBD Verifies Tutors: Our Trust & Safety Process",
    excerpt:
