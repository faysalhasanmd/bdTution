...
const PrivacyPolicy = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      content:
        "eTuitionBD uses third-party services including Firebase (authentication), MongoDB Atlas (database), and Stripe (payments). These services have their own privacy policies which we encourage you to review.",
    },
    {
      title: "6. Your Rights",
      icon: (
      ...
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed max-w-xl mx-auto">
            At eTuitionBD, your privacy is important to us. This policy explains
